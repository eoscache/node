...
#general
export SRC_CHAINNAME=eos

#CORE CONTRACT
export SRC_CORE_SYMBOL=" EOS" 
...
export SRC_CACHE_CURRENCY_STATS_SCOPE=76176668312389
...
export SRC_NETWORK_COLOR=$EOS_REBRAND  #👋 update me (optional)
